...
class AppDelegate: UIResponder, UIApplicationDelegate {
    ...
    func application(_ application: UIApplication, didFinishLaunchingWithOptions launchOptions: [UIApplicationLaunchOptionsKey: Any]?) -> Bool {
        ...
        applicationEventHandler = ApplicationFactory().createApplication(window: window)
...
extension AppDelegate {
    func initContainer() {
        let rootViewController = topNavigationFactory.createTopNavigationViewController()
    ...
    func performAppInit() {
        Promise.first { [weak self] completion in
